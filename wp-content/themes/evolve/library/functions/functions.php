...
function evolve_media() {
	...
	//get typography value from theme options.	
    ...
    $widget_title_typo = evolve_get_option('evl_widget_title_font');
    $widget_content_typo = evolve_get_option('evl_widget_content_font');

	//add typography 'face' value to array.
    ...
    $selected_fonts[4] = $parallax_font['face'];
    $selected_fonts[5] = $parallax_desc['face'];
    $selected_fonts[6] = $carousel_font['face'];
    $selected_fonts[7] = $carousel_desc['face'];    
    $selected_fonts[8] = $menu_font['face'];
    $selected_fonts[9] = $bootstrap_font['face'];
    $selected_fonts[10] = $bootstrap_desc['face'];
    $selected_fonts[11] = $widget_title_typo['face'];   
    $selected_fonts[12] = $widget_content_typo['face'];
    
    //mod by denzel, push into $selected_fonts array, all the h1 to h6 font face.
    for($i = 1; $i < 7; $i++){
		//we get all h1 to h6 fonts, evl_content_h1_font ... to evl_content_h6_font values.
		//then push into $selected fonts array.
		$h_tag = evolve_get_option('evl_content_h'.$i.'_font');
		array_push($selected_fonts,$h_tag['face']);
	}
    
    //mod by denzel, count number of fonts and use in loop below
    $number_of_fonts = count($selected_fonts);      
	
	//using the typography face array, we produce the list of google fonts to enqueue			
	$font_face_all = '';
	$j = 0;
	$font_storage[] = '';
